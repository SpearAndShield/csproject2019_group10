...
module id(clk,rst,pc_i,inst_i,reg1_data_i,reg2_data_i,
          reg1_re_o,
          reg2_re_o,reg1_addr_o,reg2_addr_o,alu_op_o,alu_sel_o,
          reg1_o,reg2_o,wd_o,wreg_o);
    input wire clk,rst;
    input wire[31:0] pc_i,inst_i,reg1_data_i,reg2_data_i;
    output reg reg1_re_o,reg2_re_o,wreg_o;
