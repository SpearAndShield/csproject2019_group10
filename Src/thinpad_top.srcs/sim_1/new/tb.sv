...
parameter EXT_RAM_INIT_FILE = "ucore.bin";    //ExtRAM初始化文件，请修改为实际的绝对路�?
parameter FLASH_INIT_FILE = "ucore-kernel-initrd";    //Flash初始化文件，请修改为实际的绝对路�?
